...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 15, 2016 at 10:00 AM
...
(1, 1, 'Một người bình luận WordPress', 'wapuu@wordpress.example', 'https://wordpress.org/', '', '2016-11-15 08:56:14', '2016-11-15 08:56:14', 'Xin chào, đây là một bình luận\nĐể bắt đầu với quản trị bình luận, chỉnh sửa hoặc xóa bình luận, vui lòng truy cập vào khu vực Bình luận trong trang quản trị.\nAvatar của người bình luận sử dụng <a href="https://gravatar.com">Gravatar</a>.', 0, '1', '', '', 0, 0);
...
(1, 'siteurl', 'http://vintage.local', 'yes'),
(2, 'home', 'http://vintage.local', 'yes'),
(3, 'blogname', 'Vintage', 'yes'),
(4, 'blogdescription', 'Một trang web mới sử dụng WordPress', 'yes'),
(5, 'users_can_register', '0', 'yes'),
(6, 'admin_email', 'khoaanh162@yahoo.com', 'yes'),
...
(1, 1, '2016-11-15 08:56:14', '2016-11-15 08:56:14', 'Chúc mừng đến với WordPress. Đây là bài viết đầu tiên của bạn. Hãy chỉnh sửa hay xóa bài viết này, và bắt đầu viết blog!', 'Chào tất cả mọi người!', '', 'publish', 'open', 'open', '', 'chao-moi-nguoi', '', '', '2016-11-15 08:56:14', '2016-11-15 08:56:14', '', 0, 'http://vintage.local/?p=1', 0, 'post', '', 1),
(2, 1, '2016-11-15 08:56:14', '2016-11-15 08:56:14', 'Đây là một trang tĩnh mẫu. Nó khác với một bài viết ở chỗ nó sẽ luôn ở một vị trí và sẽ được hiển thị tại thực đơn điều hướng trên trang mạng của bạn (với hầu hết các giao diện). Hầu hết mọi người bắt đầu với trang Giới Thiệu kể về họ với người đọc. Nó có thể được viết như sau:\n\n<blockquote>Xin chào! tôi là người chuyển hàng bằng xe đạp vào ban ngày, diễn viên luôn nỗ lực tiến bộ vào buổi tối, và đây là trang nhật ký trực tuyến của tôi. Tôi sống ở Los Angeles, tôi nuôi một con chó tuyệt vời tên là Jack, và tôi thích pi&#241;a coladas. (Và có thể gặp trong mưa.)</blockquote>\n\n...hoặc tương tự như:\n\n<blockquote>Công ty Đồ dùng XYZ được thành lập năm 1971, và đã cung cấp đồ dùng chất lượng cho cộng đồng từ thời điểm đó. Tại thành phố Gotham, XYZ tạo ra việc làm cho hơn 2,000 người và làm ra những đồ dùng tuyệt vời phục vụ mọi nhu cầu cho người dân Gotham.</blockquote>\n\nLà một người sử dụng WordPress mới, bạn nên truy cập <a href="http://vintage.local/wp-admin/">bảng thống kê</a> để xóa trang tĩnh này và tạo trang tĩnh mới cho nội dung của bạn. Hãy tận hưởng!', 'Trang Mẫu', '', 'publish', 'closed', 'open', '', 'Trang mẫu', '', '', '2016-11-15 08:56:14', '2016-11-15 08:56:14', '', 0, 'http://vintage.local/?page_id=2', 0, 'page', '', 0),
(3, 1, '2016-11-15 08:57:02', '0000-00-00 00:00:00', '', 'Lưu bản nháp tự động', '', 'auto-draft', 'open', 'open', '', '', '', '', '2016-11-15 08:57:02', '0000-00-00 00:00:00', '', 0, 'http://vintage.local/?p=3', 0, 'post', '', 0);
...
(14, 1, 'session_tokens', 'a:1:{s:64:"0058f71c4c4d78b91fb628e2a2dd4e353c709fd00de32dfc78d707c5d9514959";a:4:{s:10:"expiration";i:1479372999;s:2:"ip";s:9:"127.0.0.1";s:2:"ua";s:120:"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.98 Safari/537.36";s:5:"login";i:1479200199;}}'),
...
(1, 'admin', '$P$BX2gNsYZ5P06z0z/zeuepmrrMqXb7b1', 'admin', 'khoaanh162@yahoo.com', '', '2016-11-15 08:56:14', '', 0, 'admin');
