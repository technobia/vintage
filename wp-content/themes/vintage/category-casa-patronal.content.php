<?php
$casas_patronal_page_one = array(79, 152, 157, 160, 169, 173, 179, 691, '|', 472, 505, 543, 545, 547, 549, 551, 689, 687);
$casas_patronal_page_two = array(341, 344, 183, 349, 352, 357, 361, '|', 541, 539, 537, 535, 533, 528, 530);
$casas_patronal_page_three = array(364, 368, 374, 377, 381, 385, 389, '|', 526, 524, 522, 518, 520, 516, 514);
    ...
    <div role="tabpanel" class="tab-pane active" id="page_1">
        ...
        <div class="col-sm-12 col-md-6">
            <div class="item-inner">
                <div class="pic"><img src="<?=$thumb_url[0]?>"></div>
                <div class="info">
                    <div class="title">
